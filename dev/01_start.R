...
golem::fill_desc(
  pkg_name = "shinyclassify", # The Name of the package containing the App 
  pkg_title = "shinyclassify", # The Title of the package containing the App 
...
usethis::use_mit_license( name = "Randhir Bilkhu" )  # You can set another license here
